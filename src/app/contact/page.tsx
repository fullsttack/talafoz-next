...
import Image from "next/image";
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-gray-600 dark:text-gray-300">
      ...
      <h2 className="mt-6 font-medium text-xl">تماس با ما</h2>
      <p className="mt-2 text-gray-500 dark:text-gray-600">تماس با ما می‌توانید اطلاعات بیشتری درباره ما بگیرید</p>
    </div>
  );
}
