...
const sampleReviews = [
  {
    ...
    date: "۲ هفته پیش",
    comment:
      "دوره فوق‌العاده‌ای بود. مدرس با حوصله تمام مفاهیم را توضیح می‌دهد.",
  },
  {
    id: 2,
    user: "سارا محمدی",
        ...
        <div className="container mx-auto px-4 md:px-12 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              {/* Video Preview */}
              <div className="mb-8 max-h-[500px] overflow-hidden">
                    ...
                    <CardContent>
                      <Accordion type="single" collapsible>
                        <AccordionItem value="item-1">
                          <AccordionTrigger>
                            آیا این دوره نیاز به پیش‌نیاز دارد؟
                          </AccordionTrigger>
                          <AccordionContent>
                            خیر، این دوره از صفر شروع می‌شود و نیازی به دانش
                            قبلی ندارید.
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2">
                          <AccordionTrigger>
                            مدت زمان دسترسی به دوره چقدر است؟
                          </AccordionTrigger>
                          <AccordionContent>
                            دسترسی به دوره مادام‌العمر است و می‌توانید هر زمان
                            که خواستید به محتوا دسترسی داشته باشید.
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3">
                          <AccordionTrigger>
                            آیا گواهینامه صادر می‌شود؟
                          </AccordionTrigger>
                          <AccordionContent>
                            بله، پس از اتمام دوره و انجام تمرین‌ها، گواهینامه
                            معتبر دریافت خواهید کرد.
                          </AccordionContent>
                        </AccordionItem>
                      </Accordion>
                    </CardContent>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    {course.isFree ? (
                      // دوره رایگان
                      user ? (
                        // کاربر لاگین کرده - برو به صفحه اپیزودها
                        <Button className="w-full" size="lg" asChild>
                          <Link href={`/courses/${courseId}/episodes`}>
                            <Play className="ml-2 h-5 w-5" />
                            شروع یادگیری رایگان
                          </Link>
                        </Button>
                      ) : (
                        // کاربر لاگین نکرده - نمایش دیالوگ لاگین
                        <Dialog
                        ...
                        >
                          ...
                          <DialogContent className="sm:max-w-md">
                            <LoginDialogContent
                              ...
                              callbackUrl={`/courses/${courseId}/episodes`}
                            />
                          </DialogContent>
                        </Dialog>
                      )
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        مدرس برنامه‌نویسی با ۱۰ سال سابقه
                      </p>
                    </div>
                  </div>
                </CardContent>
