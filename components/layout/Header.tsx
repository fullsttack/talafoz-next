      ...
      <div className="relative ">
        ...
        <div className="container mx-auto w-full max-w-7xl flex justify-between py-6 items-center z-10">
          ...
          <div className="flex gap-3 items-center">
            ...
            <Button
              className="md:hidden border-none p-2 rounded-full bg-background text-foreground hover:bg-secondary transition-colors duration-300"
              onClick={toggleMenu}
              variant="outline"
              size="icon"
        ...
        <div className="md:hidden fixed inset-0 z-50 bg-background/95 pt-20">
          <div className="container mx-auto px-4">
              ...
              {[
                ...
                return (
                  <Link
                    ...
                    href={link.href}
                    onClick={toggleMenu}
                    className={`py-2 text-xl font-medium transition-colors ${
                      isActive
                        ? "text-primary font-bold"
                        : "text-foreground/70 hover:text-primary"
                    }`}
            ...
            <div className="mt-8 py-4 border-t border-border/30">
              <Button
                asChild
                className="w-full rounded-lg bg-gradient-to-r from-primary to-primary/80 text-background hover:opacity-90 transition-opacity"
              >
