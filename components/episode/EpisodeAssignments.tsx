...
export default function EpisodeAssignments({  isLocked = false }: EpisodeAssignmentsProps) {
                        ...
                        {isRecording ? (
                          <div className="bg-red-900/20 border border-red-500/30 rounded-md p-4 text-center">
                            ...
                            <button
                              ...
                              className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md flex items-center justify-center gap-1.5 mx-auto transition-colors"
                            >
